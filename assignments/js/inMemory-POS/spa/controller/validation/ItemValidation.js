...
i_vArray.push({field: $("#InputItemDescription"), regEx: ITEM_NAME_REGEX});
i_vArray.push({field: $("#inputItemUnitPrice"), regEx: ITEM_PRICE_REGEX});
i_vArray.push({field: $("#inputItemQuantity"), regEx: ITEM_QTY_REGEX});

function clearItemInputFields() {
    $("#InputItemID,#InputItemDescription,#inputItemUnitPrice,#inputItemQuantity").val("");
    $("#InputItemID,#InputItemDescription,#inputItemUnitPrice,#inputItemQuantity").css("border", "1px solid white");
    $("#InputItemID").focus();
    setItemBtn();
}
...
//disable tab
$("#InputItemID,#InputItemDescription,#inputItemUnitPrice,#inputItemQuantity").on("keydown keyup", function (e) {
